...
namespace Catalog.Controllers
{
    ...
    public class TripContoller : ControllerBase
    {
        ...
        public async Task<ActionResult> CreateTrip(CreateTripDto tripDto)
        {
            ...
            var checkCar = _carRepository.GetCar(item.Car_Id);
            var checkDriver = _driverRepository.GetDriver(item.Driver_Id);
        ...
        public  async Task<ActionResult> UpdateTrip(Guid Trip_Id, UpdateTripDto TripDto)
        {
            ...
            var checkCar = _carRepository.GetCar(updatedTrip.Car_Id);
            var checkDriver = _driverRepository.GetDriver(updatedTrip.Driver_Id);
